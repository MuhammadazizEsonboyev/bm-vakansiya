...
// if (!token || !ADMIN_CHAT_ID || !WEBHOOK_URL) {
//   console.error("❌ ENV o‘zgaruvchilar yetishmayapti");
//   process.exit(1);
// }
...
// const bot = new TelegramBot(token); // ❗ polling YO‘Q
...
// const formatAdminText = (d) => `
// 📥 <b>Yangi anketa</b>
// ━━━━━━━━━━━━━━━━━━
// 👤 <b>F.I.Sh:</b> ${escape(d.fullName)}
// 🎂 <b>Tug‘ilgan sana:</b> ${escape(d.birthDate)}
// 📞 <b>Telefon:</b> ${escape(d.phone)}
// 📍 <b>Manzil:</b> ${escape(d.address)}
// ━━━━━━━━━━━━━━━━━━
// 🎓 <b>Ma’lumoti:</b> ${escape(d.education)}
// 🏛 <b>Universitet:</b> ${escape(d.university)}
// 💼 <b>Ish tajribasi:</b> ${escape(d.experience)}
// 🌍 <b>Chet tillari:</b> ${escape(d.languages)}
// 🏅 <b>Sertifikatlar:</b> ${escape(d.certificates)}
// `;

// // ================= STEPS =================
// const steps = [
//   { key: "fullName", ask: "To‘liq F.I.Sh kiriting:" },
//   { key: "birthDate", ask: "Tug‘ilgan sana:" },
//   { key: "phone", ask: "Telefon raqam:" },
//   { key: "address", ask: "Yashash manzili:" },
//   { key: "education", ask: "Ma’lumotingiz:" },
//   { key: "university", ask: "Universitet:" },
//   { key: "experience", ask: "Ish tajribasi:" },
//   { key: "languages", ask: "Chet tillari:" },
//   { key: "certificates", ask: "Sertifikatlar:" },
//   { key: "photo", ask: "Rasm yuboring:", type: "photo" },
// ];
...
//     return bot.sendMessage(chatId, "📝 Anketa boshlandi");
//   }
...
//     if (!photo) return bot.sendMessage(chatId, "Rasm yuboring");

//     session.data.photo = photo.file_id;

//     await bot.sendMessage(
//       chatId,
//       "✅ Anketa qabul qilindi. Tez orada siz bilan bog‘lanamiz 📞"
//     );

//     await bot.sendPhoto(
//       ADMIN_CHAT_ID,
//       session.data.photo,
//       { caption: formatAdminText(session.data), parse_mode: "HTML" }
//     );
...
//     return bot.sendMessage(chatId, steps[session.step].ask);
//   }
// });
...
const token = process.env.BOT_TOKEN;
const ADMIN_CHAT_ID = process.env.ADMIN_CHAT_ID;
const WEBHOOK_URL = process.env.WEBHOOK_URL; // masalan: https://your-app.onrender.com
const PORT = process.env.PORT || 3000;
...
if (!WEBHOOK_URL) {
  console.error("❌ WEBHOOK_URL topilmadi. Render Environment ga WEBHOOK_URL yozing.");
  process.exit(1);
}
...
// ✅ Render uchun: botni polling/webhook-port ochmasdan yaratamiz
...
// Server start + webhook set (Render uchun)
app.listen(PORT, async () => {
  try {
    // deleteWebhook kerak emas (sizdagi versiyada yo‘q)
    // Webhookni shunchaki qayta o‘rnatamiz:
    await bot.setWebHook(FULL_WEBHOOK_URL, { drop_pending_updates: true });
